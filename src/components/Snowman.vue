<template>
    <div class="snowman">
        <svg viewBox="0 0 800 900" xmlns="http://www.w3.org/2000/svg">
            <g>
                <!-- head -->
                <circle v-if="isVisible('head')" cx="428.5" cy="218" r="109.5" fill="#FFF" stroke="#000" stroke-width="10"></circle>
                <!-- end head -->
                <!-- hat -->
                <path v-if="isVisible('hat')" d="M355.9634,293.1135c0,0,0.042,0.0273,0.1055,0.0686c-19.1035-18.7979-30.9585-44.9404-30.9585-73.8594
                ...
                <!-- end mouth -->
                <!-- body bottom only -->
                <circle v-if="isVisible('body-one')" cx="434" cy="647" r="197.65" fill="#FFF" stroke="#000" stroke-width="10"></circle>
                <!-- end body bottom only -->
                <!-- body belly -->
                <path v-if="isVisible('body-two')" fill="#FFFFFF" d="M530.0215,316.02c0,0,6.313,38.6023-4.1182,55.783s-36.8154-1.8408-36.8154-1.8408
                ...
                <!-- end body belly -->
                <!-- body combined -->
                <path v-if="isVisible('body-two')" d="M570.3271,502.7969c14.647-24.6261,22.3438-52.6091,22.3438-81.5327c0-20.6133-3.9727-40.63-11.3496-59.1466
                ...
                <!-- end buttons -->
                <!-- scarf -->
                <path v-if="isVisible('scarf')" fill="#E4122A" d="M494.3218,322.6777c-19.7993,38.7681-5.2339,47.2844-5.2339,47.2844s26.3843,19.0215,36.8154,1.8408
