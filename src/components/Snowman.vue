<template>
    <div class="snowman">
        <svg viewBox="0 0 800 900" xmlns="http://www.w3.org/2000/svg">
            <g>
                <!-- head -->
                <circle v-if="maxGuesses - guessCount > 8" cx="428.5" cy="218" r="109.5" fill="#FFF" stroke="#000" stroke-width="10"></circle>
                <!-- end head -->
                <!-- hat -->
                <path v-if="maxGuesses - guessCount > 17" d="M355.9634,293.1135c0,0,0.042,0.0273,0.1055,0.0686c-19.1035-18.7979-30.9585-44.9404-30.9585-73.8594
                ...
                <!-- end hat -->
                <!-- eyes -->
                <circle v-if="maxGuesses - guessCount > 15" cx="399.1633" cy="177.4346" r="14.2165"/>
                <circle v-if="maxGuesses - guessCount > 14" cx="463.6113" cy="177.4346" r="14.2165"/>
                <!-- end eyes -->
                <!-- nose -->
                <path v-if="maxGuesses - guessCount > 16" fill="#F07E26" d="M427.619,201.3945c0,0-70.8824,17.7848-70.7149,21.7985s74.8143,11.3732,74.8143,11.3732
                    S449.6187,216.1778,427.619,201.3945z"/>
                <!-- end nose -->
                <!-- mouth -->
                <circle v-if="maxGuesses - guessCount > 13" cx="392.865" cy="251.5671" r="5.7299"/>
                <circle v-if="maxGuesses - guessCount > 12" cx="405.3212" cy="264.0234" r="5.7299"/>
                <circle v-if="maxGuesses - guessCount > 11" cx="424.2927" cy="271.077" r="5.7299"/>
                <circle v-if="maxGuesses - guessCount > 10" cx="440.5435" cy="263.9806" r="5.7299"/>
                <circle v-if="maxGuesses - guessCount > 9" cx="453.8644" cy="252.5437" r="5.7299"/>
                <!-- end mouth -->
                <!-- body bottom only -->
                <circle v-if="maxGuesses - guessCount > 0" cx="434" cy="647" r="197.65" fill="#FFF" stroke="#000" stroke-width="10"></circle>
                <!-- end body bottom only -->
                <!-- body belly -->
                <path v-if="maxGuesses - guessCount > 1" fill="#FFFFFF" d="M530.0215,316.02c0,0,6.313,38.6023-4.1182,55.783s-36.8154-1.8408-36.8154-1.8408
                ...
                <!-- end body belly -->
                <!-- body combined -->
                <path v-if="maxGuesses - guessCount > 1" d="M570.3271,502.7969c14.647-24.6261,22.3438-52.6091,22.3438-81.5327c0-20.6133-3.9727-40.63-11.3496-59.1466
                ...
                <!-- end body  -->
                <!-- buttons -->
                <circle v-if="maxGuesses - guessCount > 7" cx="428.8416" cy="361.3082" r="15.4323"/>
                <circle v-if="maxGuesses - guessCount > 6" cx="428.8416" cy="416.1787" r="15.4323"/>
                <circle v-if="maxGuesses - guessCount > 5" cx="428.8416" cy="471.0493" r="15.4323"/>
                <!-- end buttons -->
                <!-- scarf -->
                <path v-if="maxGuesses - guessCount > 4" fill="#E4122A" d="M494.3218,322.6777c-19.7993,38.7681-5.2339,47.2844-5.2339,47.2844s26.3843,19.0215,36.8154,1.8408
                ...
                <!-- end eyes -->
                <!-- arm right -->
                <path v-if="maxGuesses - guessCount > 3" fill="#773E23" d="M775.8827,398.3766l-36.0902-22.8739l46.3643-13.4827l-3.1963-10.9914l-47.8118,13.9036l13.569-41.6581
                ...
                <!-- end arm right -->
                <!-- arm left -->
                <path v-if="maxGuesses - guessCount > 2" fill="#773E23" d="M90.6001,416.3666l34.4269-25.3083l-47.1837-10.2532l2.4307-11.1857l48.6567,10.5733l-16.4095-40.6231
